...
func CreateProviderFromConfig(cfg *config.ModelConfig) (LLMProvider, string, error) {
	...
	case "openrouter", "litellm", "lmstudio", "groq", "zhipu", "nvidia", "novita",
		"ollama", "moonshot", "deepseek", "cerebras", "vivgrid", "volcengine",
		"vllm", "qwen", "qwen-intl", "qwen-international", "dashscope-intl",
		"qwen-us", "dashscope-us", "mistral", "modelscope", "venice":
